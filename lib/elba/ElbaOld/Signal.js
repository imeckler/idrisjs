...
Elm.Signal = function(elm) {
  ...
  function lift3(func, a, b, c) {
    function update() { return func( a.value, b.value, c.value ); }
    return new LiftN(update, [a,b,c]);
  }
  function lift4(func, a, b, c, d) {
    function update() { return func( a.value, b.value, c.value, d.value ); }
    return new LiftN(update, [a,b,c,d]);
  }
  function lift5(func, a, b, c, d, e) {
    function update() { return func( a.value, b.value, c.value, d.value, e.value ); }
    return new LiftN(update, [a,b,c,d,e]);
  }
  function lift6(func, a, b, c, d, e, f) {
    function update() { return func( a.value, b.value, c.value, d.value, e.value, f.value ); }
    return new LiftN(update, [a,b,c,d,e,f]);
  }
  function lift7(func, a, b, c, d, e, f, g) {
    function update() { return func( a.value, b.value, c.value, d.value, e.value, f.value, g.value ); }
    return new LiftN(update, [a,b,c,d,e,f,g]);
  }
  function lift8(func, a, b, c, d, e, f, g, h) {
    function update() { return func( a.value, b.value, c.value, d.value, e.value, f.value, g.value, h.value ); }
  ...
  function Foldp(step, state, input) {
    ...
    this.recv = function(timestep, changed, parentID) {
      if (changed) {
          this.value = step( input.value, this.value );
      }
      send(this, timestep, changed);
    };
  ...
  function dropWhen(s1,b,s2) {
    var pairs = lift2((function(x,y){return {x:x,y:y};}), s1, s2 );
  ...
  function delay(t,s) {
      ...
      return new SampleOn(delayed, lift2(first, delayed, lift(update,s)));
  }
  ...
  return elm.Native.Signal = {
    ...
    merge : merge,
   // merges : merges,
    count : function(s) { return foldp((function(_,c) { return c+1; }), 0, s); },
    countIf : (function(pred,s) {
      return foldp((function(x,c){
        return pred(x) ? c+1 : c; }), 0, s)}),
    keepIf : (function(pred,base,sig) {
